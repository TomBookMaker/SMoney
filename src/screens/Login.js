        ...
        <KeyboardAvoidingView style={{ flex: 1, paddingTop: 40, backgroundColor:'white' }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}
            ...
            <ScrollView contentContainerStyle={{ flex: 1, alignItems: 'center' }} >
                ...
                <View style={{ flex: 1, width: '100%', alignItems: 'center' }}>
                    <TouchableOpacity style={{
                        height: '30%', width: (windowWidth - 200), backgroundColor: '#2EB84C'
                        , marginTop: 20, borderRadius: 8,
                        justifyContent: 'center', alignItems: 'center'
                    }}>

                        <Text style={{ fontSize: 15, fontWeight: 500, color: '#FFF' }}>ĐĂNG NHẬP</Text>
                    ...
                    >
                        ...
                        <TouchableOpacity style={{
                            height: '50%', width: (windowWidth - 250), backgroundColor: '#FFF'
                            , borderRadius: 10,
                            justifyContent: 'center', alignItems: 'center'
                        }}
                            onPress={() => {
                        ...
                        >
                            ...
                            <Text style={{ fontSize: 15, fontWeight: 500, color: '#2EB84C' }}>Đăng Ký</Text>
                        ...
                        <TouchableOpacity style={{
                            ...
                            <Text style={{ fontSize: 15, fontWeight: 500, color: '#2EB84C' }}>Quên mật khẩu?</Text>
